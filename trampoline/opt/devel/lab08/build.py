...
#--- OIL file
oilSourceList.append("lab08.oil")
...
cSourceList.append(projfile.ProjectFile("lab08.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab08/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab08/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab08/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab08/tpl_interrupts.c"))
